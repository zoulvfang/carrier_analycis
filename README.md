...
（1）对订单量大且高运费的州如SP、MG，PR增设区域配送仓，参考异常高运费订单最多的TOP10路线，发运州SP需要在本州再建立一个区域仓，同时分别在到货州RJ与MG各建立自己的区域仓，发运州PR与MG可考虑在到货州SP分别建立自己的区域仓，以解决跨州远距离高运费难题。通过测算，若把20%的跨州运输转同州运输（运费平均降低73.7%），则总运费降幅约为14.7%（20%x73.7%）；
